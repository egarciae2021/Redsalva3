		...
		<div class="container">
			<div class="d-sm-flex text-center">
				<div class="align-self-center">
					<h2 class="h3 g-font-weight-300 w-100 g-mb-10 g-mb-0--md">Hepatitis B</h2>
				</div>
				...
				<div class="align-self-center ml-auto">
					<ul class="u-list-inline">
						...
						<li class="list-inline-item g-mr-5">
							<a class="u-link-v5 g-color-main" href="/especialidades/pediatria-vacunas">Pediatria - Vacunas</a>
							<i class="g-color-gray-light-v2 g-ml-5">/</i>
						</li>
...
<section class="container g-pt-50 g-pb-40">
	<div class="row">
		<div class="col-lg-7">
			<p><span class="u-dropcap g-color-topbar-montesur g-mr-20 g-mb-10">L</span><strong>aboratorio: </strong>GSK</p>
			...
			<p class="g-brd-txt-montesur"><strong>¿Cuándo debe colocarse esta vacuna?</strong></p>
			<p>Los niños deben recibir 1 dosis:</p>
			<ul>
				<li><strong>Primera dosis*:</strong><br>Al nacer.</li>
			</ul>
			<p><small><strong>* </strong>Esta vacuna está incluida en la Hexavalente, que es aplicada a los 2, 4, 6 y 18 meses.</small></p>
			<p class="g-brd-txt-montesur"><strong>¿Esta vacuna tiene efectos secundarios?</strong></p>
		...
		<div class="col-lg-5">
			<img src="/img/pediatria-vacunas/hepatitis-b.jpg" class="img-fluid g-brd-around g-brd-montesur u-shadow-v2" width="100%" alt="<?php echo $page_title;?>" title="<?php echo $page_title;?>">
		</div>
	</div>
